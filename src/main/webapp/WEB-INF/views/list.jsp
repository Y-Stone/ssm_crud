    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            <button class="btn btn-primary" id="addEmp_btn">
                <span class="glyphicon glyphicon glyphicon-plus-sign" aria-hidden="true"/>&nbsp;新增
            </button>
            <button class="btn btn-danger" id="delEmp_btn">
                <span class="glyphicon glyphicon glyphicon-minus-sign" aria-hidden="true"/>&nbsp;删除
            </button>
            <button class="btn btn-danger" id="logout_btn">
                <span class="glyphicon glyphicon glyphicon-off" aria-hidden="true"/>&nbsp;退出
            </button>
        </div>
    </div>
    <!--表格数据-->
...
<script type="text/javascript">
    ...
    $("#logout_btn").click(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                // alert(result);
                //必须手动跳转页面，Ajax使得springmvc退出的操作直接返回页面字符串给result，而非跳转页面
                window.location = "${APP_PATH}/toLogin";
            }
        });
